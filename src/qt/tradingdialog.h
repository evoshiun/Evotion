...
private slots:
    ...
    void on_BuyEVO_clicked();
    void on_SellEVOBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputEVO_textChanged(const QString &arg1);
    ...
    QString BuyEVO(QString OrderType, double Quantity, double Rate);
    QString SellEVO(QString OrderType, double Quantity, double Rate);

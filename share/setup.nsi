...
!define URL http://www.evotion.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/evotion.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\evotion-qt.exe
...
OutFile evotion-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/evotion-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/evotiond.exe
    ...
    #Delete /REBOOTOK $INSTDIR\evotion.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\evotion-qt.exe

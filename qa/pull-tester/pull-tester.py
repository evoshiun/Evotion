...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old EvotionPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/EvotiondComparisonTool_jar/EvotiondComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/evotion/evotion.git")
...
environ_default("BUILD_PATH", "/mnt/evotion")
...
environ_default("GITHUB_REPO", "evotion/evotion")

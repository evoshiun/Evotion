...
#ifndef H_EVOTION_SCRIPT
#define H_EVOTION_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEvotionAddress
 */
...
public:
    ...
    // Pre-version-0.6, Evotion always counted CHECKMULTISIGs

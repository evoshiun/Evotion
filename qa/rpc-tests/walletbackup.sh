...
function StartThree {
  $EVOTIOND $EVOTIONDARGS $B1ARGS &
  B1PID=$!
  $EVOTIOND $EVOTIONDARGS $B2ARGS &
  B2PID=$!
  $EVOTIOND $EVOTIONDARGS $B3ARGS &
  B3PID=$!
}
